...
export const ATPLPathwayPage: React.FC<ATPLPathwayPageProps> = ({ onBack, onLogout }) => {
    return (
        <div className="dashboard-container animate-fade-in">
            <main className="dashboard-card" style={{ position: 'relative' }}>
                ...
                <div className="dashboard-header" style={{ marginBottom: '3rem', paddingBottom: '1rem', borderBottom: '1px solid #e2e8f0' }}>
                    ...
                    <h1 className="dashboard-title" style={{ fontSize: '2.5rem' }}>Emirates ATPL Pathway</h1>
                    <p style={{ maxWidth: '600px', margin: '0 auto' }}>
                        A structured roadmap designed to take you from a novice to a certified ATPL pilot, heavily modeled off the Emirates Flight Training Academy standards.
                    </p>
                </div>
