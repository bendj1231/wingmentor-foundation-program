                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '5rem' }}>
                    ...
                    <section>
                        ...
                        <div style={{ color: '#475569', fontSize: '1.05rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                            ...
                            <p>
                                And here is the unspoken truth: you are not the only one who knows this reality. Deep down, the instructors who taught you know it. The head of your flight college knows it. But they are bound by a different directive. Their job is simply to keep the aviation pipeline flowing—churning out licenses to meet the foundational demand, while leaving the massive burden of operational readiness entirely on your shoulders. Most pilots rely entirely on their flight school, totally trusting the process they laid out. For a school to admit that their CPL doesn't actually make you airline-ready would be like telling a child that Santa Claus isn't real. So, they keep you dreaming your goal, and leave you to discover the gap on your own. To be fair, if flight schools laid out the brutal truth of these requirements on day one, many aspiring aviators—perhaps even you—would have never taken the leap, and these schools would go out of business. Ultimately, the fault doesn't lie maliciously with the schools; it lies with the rigid, outdated regulations that created this chasm in the first place.
                            </p>
